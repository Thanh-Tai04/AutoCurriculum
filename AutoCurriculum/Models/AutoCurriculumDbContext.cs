...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ChapterId).HasName("PK__Chapters__0893A36AE41DF078");
        ...
        {
            entity.HasKey(e => e.ContentId).HasName("PK__Contents__2907A81ED1F7D970");
        ...
        {
            entity.HasKey(e => e.HistoryId).HasName("PK__Curricul__4D7B4ABD1C63D3BF");
        ...
        {
            entity.HasKey(e => e.LessonId).HasName("PK__Lessons__B084ACD0C8F10270");
        ...
        {
            entity.HasKey(e => e.SectionId).HasName("PK__Sections__80EF08724FF1D3DF");
        ...
        {
            entity.HasKey(e => e.SourceId).HasName("PK__Sources__16E019194B7FEF89");
        ...
        {
            entity.HasKey(e => e.TopicId).HasName("PK__Topics__022E0F5D0AB14ED0");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C10CBFB6D");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E485271B7D").IsUnique();
