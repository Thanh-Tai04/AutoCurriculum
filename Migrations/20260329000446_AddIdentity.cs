        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetrievedDate = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Sources__16E01919CA632BF3", x => x.SourceId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Topics__022E0F5DE2DC64EC", x => x.TopicId);
                    table.ForeignKey(
                        name: "FK_Topics_Sources",
                        column: x => x.SourceId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChapterOrder = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Chapters__0893A36A5338C271", x => x.ChapterId);
                    table.ForeignKey(
                        name: "FK_Chapters_Topics",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Curricul__4D7B4ABDB44AF841", x => x.HistoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TocLevel = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Sections__80EF0872724A1D50", x => x.SectionId);
                    table.ForeignKey(
                        name: "FK_Sections_Chapters",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonTitle = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    LessonOrder = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Lessons__B084ACD0B1413EB8", x => x.LessonId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentOrder = table.Column<int>(type: "int", nullable: true, defaultValue: 1),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Contents__2907A81EDF4EBC2B", x => x.ContentId);
                    table.ForeignKey(
                        name: "FK_Contents_Lessons",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Chapters",
                columns: new[] { "TopicId", "ChapterOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurriculumHistory_TopicId",
                table: "CurriculumHistory",
                column: "TopicId");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Sections",
                columns: new[] { "ChapterId", "SectionOrder" });
